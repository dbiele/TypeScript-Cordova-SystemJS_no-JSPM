...
Locate systemjs in the node_modules folder.  Each package is structured different by publisher and it’s import to know the files necessary to use for distribution.  
